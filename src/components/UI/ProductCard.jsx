...
// //           width: 85%;
// //           padding: 12px;
// //           background-color: #e63946 !important; /* লাল ব্যাকগ্রাউন্ড */
// //           color: #ffffff;
// //           border: none;
// //           font-weight: 800;
// //           font-size: 0.8rem;
...
// //           bottom: 15px; /* হোভার করলে নিচ থেকে ওপরে উঠবে */
// //         }
...
// //             onClick={(e) => {
// //               e.stopPropagation(); // কার্ডের প্যারেন্ট ক্লিকে দ্বৈত ট্রিগার রিমুভ করার জন্য
...
//     e.stopPropagation(); // কার্ডের প্যারেন্ট ক্লিকে নেভিগেশন বন্ধ করা
//     setActiveImage(product.image); // ডিফল্ট ইমেজ সেট
//     setIsModalOpen(true);
//   };
...
//               {/* Angle Switcher (Front/Back) */}
//               <div style={{ display: "flex", gap: "10px" }}>
//                 {[product.image, product.backImage].map(
//                   (img, idx) =>
//                     img && (
//                       <button
//                         key={idx}
...
//             {/* Modal Right: Details & Call-To-Action */}
//             <div
//               style={{
//                 display: "flex",
...
//               >
//                 {product.description ||
//                   "Heavyweight premium cotton streetwear oversized fit with Japanese anime inspired artwork."}
//               </p>
